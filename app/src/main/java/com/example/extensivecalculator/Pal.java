...
public class Pal extends AppCompatActivity {
    ...
    public void back (View v){
        Intent intent= new Intent(Pal.this, MainActivity.class);
    ...
    public void count (View v){
        ...
        if (bases.equals("") || heights.equals("")){
            Toast.makeText(Pal.this, "dont fill it empty", Toast.LENGTH_LONG).show();
        }else {
            int bsae = Integer.parseInt(bases);
            int height = Integer.parseInt(heights);
            result.setText(String.valueOf(bsae*height));
        }
    }
}
